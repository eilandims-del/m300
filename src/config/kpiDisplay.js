    ...
    indicators: [
      {
        kpi: '1º Login',
        max: 13.6,
        formula: 'Hora média do 1º login (horas decimais)',
        range: '7h – 12h',
        better: 'lower',
        note: 'Pontualidade de início da jornada. Login mais cedo, mais pontos.'
      },
      {
        kpi: '1º Desloc.',
        max: 13.6,
        formula: 'Tempo médio entre login e 1º deslocamento (min)',
        range: '20 – 30 min',
        better: 'lower',
        note: 'Agilidade de saída da equipe para o campo.'
      },
      {
        kpi: 'Retorno Base',
        max: 7.5,
    ...
    indicators: [
      {
        kpi: '1º Despacho',
        max: 0,
        formula: 'Média do 1º despacho (min)',
        range: '—',
        better: 'lower',
